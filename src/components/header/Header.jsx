          ...
          item.active ? (
            <li key={item.name}>
              <button
                ...
                className="inline-block px-0 sm:px-4 py-2 duration-500 hover:bg-blue-100 rounded-full text-xs sm:text-sm text-white md:text-md lg:text-md xl:text-md m-3"
              >
                {item.name}
              </button>
            </li>
